...
export { default as CursorTrail } from './ui/CursorTrail';
export { default as TypewriterText } from './ui/TypewriterText';
export { default as ParallaxElement } from './ui/ParallaxElement';
...
export type { EducationProps } from './sections/Education';